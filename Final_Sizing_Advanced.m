...
Airfoil = 0; % 1 = Conventional, 0 = Supercritical
TOFL = 9000; % Feet
...
for sweep1 = 35
    ...
    title('DOC vs. Aspect Ratio for Conventional Aircraft')
    ...
    legend('Sweep = 10 degs','Sweep = 15 degs','Sweep = 20 degs','Sweep = 25 degs','Sweep = 30 degs','Sweep = 35 degs','Sweep = 40 degs')
    title('Takeoff Weight vs. Aspect Ratio for Conventional Aircraft')
    xlabel('Aspect Ratio (AR)')
    ylabel('Weight (lbs)')
    grid on
end
